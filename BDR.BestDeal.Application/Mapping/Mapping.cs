...
public static class Mapping
{
    ...
    public static Response ToResponse(this WareHouseResponse response) => Response.Create(response.Amount,"DimAddress");
    public static Response ToResponse(this ConsigneeResponse response) => Response.Create(response.Total,"Cargonizer");
}